...
Q_CONSTINIT static const qt_meta_stringdata_ListView_t qt_meta_stringdata_ListView = {
    {
        ...
        QT_MOC_LITERAL(9, 8),  // "viewItem"
        QT_MOC_LITERAL(18, 0),  // ""
        QT_MOC_LITERAL(19, 13),  // "MinecraftObj*"
        QT_MOC_LITERAL(33, 3),  // "obj"
        QT_MOC_LITERAL(37, 8),  // "editItem"
        QT_MOC_LITERAL(46, 7),  // "addItem"
        QT_MOC_LITERAL(54, 7),  // "tempObj"
        QT_MOC_LITERAL(62, 16),  // "onRefreshClicked"
        QT_MOC_LITERAL(79, 19)   // "onSearchTextChanged"
    },
    "ListView",
    "viewItem",
    "",
...
void ListView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->viewItem((*reinterpret_cast< std::add_pointer_t<MinecraftObj*>>(_a[1]))); break;
        case 1: _t->editItem((*reinterpret_cast< std::add_pointer_t<MinecraftObj*>>(_a[1]))); break;
        case 2: _t->addItem((*reinterpret_cast< std::add_pointer_t<MinecraftObj*>>(_a[1]))); break;
        ...
        {
            using _t = void (ListView::*)(MinecraftObj * );
            if (_t _q_method = &ListView::viewItem; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ListView::*)(MinecraftObj * );
            if (_t _q_method = &ListView::editItem; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (ListView::*)(MinecraftObj * );
            if (_t _q_method = &ListView::addItem; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void ListView::viewItem(MinecraftObj * _t1)
{
...
// SIGNAL 1
void ListView::editItem(MinecraftObj * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 2
void ListView::addItem(MinecraftObj * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
